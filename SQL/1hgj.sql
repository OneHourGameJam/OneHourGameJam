...
CREATE TABLE `user` (
  ...
  `user_preferences` int(11) DEFAULT '0',
  PRIMARY KEY (`user_id`),
...
(null,Now(), '1', 'JAM_THEMES_CONSIDERED_RECENT', '26', 'JAM_SETTINGS', 'Minimum number of jams to pass before allowing suggestion of a recently used theme.', 'NUMBER', '[]', '1', '1', '1');
