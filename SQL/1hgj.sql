...
(50,'2018-10-24 02:29:45','-1','SESSION_PASSWORD_ITERATIONS','150','SECURITY','Number of hashing iterations for session IDs, for security reasons this can only be changed manually in the config file.','NUMBER','[]',0,1,0),
...
(42,'2018-10-24 02:29:45','-1','RULES','','RULES','Jam rules, displayed on the rules page','TEXTAREA','[]',1,1,1),
