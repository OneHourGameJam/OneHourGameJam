    ...
    function LoadSiteActions(&$configData){
        ...
        $actions = Array(
            ...
            new SiteActionModel(
                ...
                "?".GET_PAGE."=".PAGE_MAIN,
                Array(
                    "SUCCESS_INSERTED" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_SUCCESS, "Asset added."),
                    "SUCCESS_UPDATED" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_SUCCESS, "Asset updated"),
                    "COULD_NOT_DETERMINE_URL" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_ERROR, "Could not find a URL for the asset. Please look at the assets folder on the web server."),
                    "UNLOADED_ASSET_TOO_BIG" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "Asset too big."),
                    ...
                    "INVALID_ASSET_TYPE" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "Invalid asset type."),
                    "ASSET_TYPE_EMPTY" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "Missing asset type."),
                    "INVALID_DESCRIPTION" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "Invalid description."),
                    "INVALID_TITLE" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "Invalid title."),
                    "INVALID_AUTHOR" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "Invalid author - must match a username of a registered user."),
                    "AUTHOR_EMPTY" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_WARNING, "missing author."),
                    "NOT_AUTHORIZED" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_MAIN, MESSAGE_ERROR, "Only admins can perform this action."),
                )
            ),
            new SiteActionModel(
                ...
                "?".GET_PAGE."=".PAGE_MAIN,
                Array(
                    "SUCCESS" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_SUCCESS, "Asset deleted."),
                    "ASSET_DOES_NOT_EXIST" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_ERROR, "asset does not exist."),
                    "NOT_AUTHORIZED" => new SiteActionResultModel("?".GET_PAGE."=".PAGE_ASSETS, MESSAGE_ERROR, "Only admins can perform this action."),
                )
            ),
            new SiteActionModel(
